 ...
 * your design before combining them together.
 * <p/>
 * This demo is only for illustrative purpose. Please refer to the comments inside it for more
 * details.
 */
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onPageFinished(WebView view, String url) {
                    controller.refreshPage(view);// This works as the webView is the view for a
                                                 // page. Please use refreshPage(int pageIndex) if
                                                 // the webview is only a part of page view.
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                ...
                public void onProgressChanged(WebView view, int newProgress) {
                    if (newProgress - lastRefreshProgress > 20) { // limit the invocation frequency
                                                                  // of refreshPage
